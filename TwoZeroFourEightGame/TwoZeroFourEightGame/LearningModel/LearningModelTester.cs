...
namespace LearningModel
{
    class LearningModelTester
    {
        ...
        private void DataSet_ANDGate(out LearningModel<double> a, out Matrix<double> i1, out Matrix<double> o1,
        out Matrix<double> i2, out Matrix<double> o2, out Matrix<double> i3, out Matrix<double> o3, out Matrix<double> i4, out Matrix<double> o4)
        {
        ...
        private void DataSet_Complex(out LearningModel<double> a, out Matrix<double> i1, out Matrix<double> o1,
        out Matrix<double> i2, out Matrix<double> o2, out Matrix<double> i3, out Matrix<double> o3, out Matrix<double> i4, out Matrix<double> o4)
        {
        ...
        private void DataSet_WhichQuadrantDotBelongs(out LearningModel<double> a, out Matrix<double> i1, out Matrix<double> o1,
        out Matrix<double> i2, out Matrix<double> o2, out Matrix<double> i3, out Matrix<double> o3, out Matrix<double> i4, out Matrix<double> o4)
        {
        ...
        public void ConsoleInterface()
        {
            ...
            DataSet_WhichQuadrantDotBelongs(out a, out i1, out o1, out i2, out o2, out i3, out o3, out i4, out o4);
            do
            {
        ...
        static void CircularClassification()
        {
            int[] layer = { 2, 4, 1, 2 };
